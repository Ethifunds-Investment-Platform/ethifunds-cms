...
export default React.memo(function ApproveListingDialog() {
	...
	const { data, isFetching, isError, error } = useQuery(["approve-listing", id], () =>
	...
	const open = React.useMemo(() => {
		return dialog.show && dialog.type === "approve_listing";
			...
			<ErrorBoundary>
				<Render isLoading={isFetching} isError={isError} error={error} loadingPosition="center">
					<div className="flex flex-col gap-3">
						<h1 className="highlight-standard text-neutral-1000">Approve Listing</h1>
						<span>Are you sure you want to approve this listing?</span>
