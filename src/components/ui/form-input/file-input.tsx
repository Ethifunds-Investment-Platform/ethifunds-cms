...
const FileInput = React.forwardRef<Ref, InputProps>((props: InputProps, ref) => {
	...
	return (
		<div className={container}>
			...
			<div className={cn}>
				<label htmlFor={name} className="flex cursor-pointer flex-col items-center gap-2">
					<div className="flex items-center justify-center size-10 rounded-full bg-neutral-100">
					...
					{rest.maxFileSize && (
						<span className="text-xs text-neutral-500">Max size: {rest.maxFileSize}</span>
					)}
				</label>
				<input
					ref={ref}
...
// <label htmlFor="upload-doc" className="flex cursor-pointer flex-col items-center gap-2">
