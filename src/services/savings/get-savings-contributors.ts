...
type Response = PaginatedResponse<SavingsContributor>;

export async function production(data: Parameters): Promise<Response> {
	const response = await axios.get(`/savings/contributors${data.query_string}`);
...
export default async function getSavingsContributors(data: Parameters): Promise<Response> {
