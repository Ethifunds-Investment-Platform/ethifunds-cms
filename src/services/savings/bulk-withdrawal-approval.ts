...
export async function production(data: Parameters): Promise<Response> {
	const response = await axios.post(`/ethicoop/withdrawals/approve-bulk`, data);
...
export default async function bulkWithdrawalApproval(data: Parameters): Promise<Response> {
